...
desktop, on a schedule, or pasted into a System Center Orchestrator runbook. There's nothing to install first, and it runs on the PowerShell
built into Windows.
